...
var setCustomSelect = function setCustomSelect() {
  var select;
  var button;
  var options;
  var input;
...
/***/ "./js/modules/init-guides-slider.js":
/*!******************************************!*\
  !*** ./js/modules/init-guides-slider.js ***!
  \******************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initGuidesSlider: function() { return /* binding */ initGuidesSlider; }
/* harmony export */ });
/* harmony import */ var _vendor_swiper_bundle_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../vendor/swiper-bundle.js */ "./js/vendor/swiper-bundle.js");

var slider = document.querySelector('[data-slider="guides"]');
var breakpointMediaDesktop = window.matchMedia('(min-width: 1600px)');
var breakpointMediaNotebook = window.matchMedia('(min-width: 1200px)');
var breakpointMediaTablet = window.matchMedia('(min-width: 768px)');
var breakpointMediaMobile = window.matchMedia('(min-width: 320px)');
var totalSlides;
var visibleSlides;
var fraction;
var breakpointChecker = function breakpointChecker() {
  ...
  if (fraction) {
    fraction.textContent = "1 / ".concat(totalSlides - visibleSlides + 1);
  }
...
var initGuidesSlider = function initGuidesSlider() {
  if (!slider) {
    return;
  }
  var controls = document.querySelector('[data-slider-controls="guides"]');
  var prev = controls.querySelector('[data-slider-control="prev"]');
  var next = controls.querySelector('[data-slider-control="next"]');
  fraction = controls.querySelector('[data-slider-fraction]');
  totalSlides = slider.querySelectorAll('.swiper-slide').length;
  breakpointChecker();
  var swiper = new _vendor_swiper_bundle_js__WEBPACK_IMPORTED_MODULE_0__.Swiper(slider, {
    slidesPerView: 4,
    spaceBetween: 40,
    navigation: {
      nextEl: next,
    ...
    on: {
      slideChange: function slideChange() {
        fraction.textContent = "".concat(swiper.realIndex + 1, " / ").concat(totalSlides - visibleSlides + 1);
      }
    }
  });
};
...
/***/ "./js/modules/init-popular-tours-slider.js":
/*!*************************************************!*\
  !*** ./js/modules/init-popular-tours-slider.js ***!
  \*************************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initPopularToursSlider: function() { return /* binding */ initPopularToursSlider; }
/* harmony export */ });
/* harmony import */ var _vendor_swiper_bundle_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../vendor/swiper-bundle.js */ "./js/vendor/swiper-bundle.js");

var slider = document.querySelector('[data-slider="popular-tours"]');
var breakpointMediaDesktop = window.matchMedia('(min-width: 1600px)');
var breakpointMediaNotebook = window.matchMedia('(min-width: 1200px)');
var breakpointMediaTablet = window.matchMedia('(min-width: 768px)');
var breakpointMediaMobile = window.matchMedia('(min-width: 320px)');
...
var initPopularToursSlider = function initPopularToursSlider() {
  if (!slider) {
    return;
  }
  var controls = document.querySelector('[data-slider-controls="popular-tours"]');
  var prev = controls.querySelector('[data-slider-control="prev"]');
  var next = controls.querySelector('[data-slider-control="next"]');
  fraction = controls.querySelector('[data-slider-fraction]');
  totalSlides = slider.querySelectorAll('.swiper-slide').length;
...
/***/ "./js/modules/init-tour-reviews-slider.js":
/*!************************************************!*\
  !*** ./js/modules/init-tour-reviews-slider.js ***!
  \************************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initTourReviewsSlider: function() { return /* binding */ initTourReviewsSlider; }
/* harmony export */ });
/* harmony import */ var _vendor_swiper_bundle_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../vendor/swiper-bundle.js */ "./js/vendor/swiper-bundle.js");

var slider = document.querySelector('[data-slider="tour-reviews"]');
var breakpointMediaDesktop = window.matchMedia('(min-width: 1024px)');
var breakpointMediaMobile = window.matchMedia('(min-width: 320px)');
var totalSlides;
var visibleSlides;
var fraction;
...
var initTourReviewsSlider = function initTourReviewsSlider() {
  if (!slider) {
    return;
  }
  var controls = document.querySelector('[data-slider-controls="tour-reviews"]');
  var prev = controls.querySelector('[data-slider-control="prev"]');
  var next = controls.querySelector('[data-slider-control="next"]');
  fraction = controls.querySelector('[data-slider-fraction]');
  totalSlides = slider.querySelectorAll('.swiper-slide').length;
...
/* harmony import */ var _modules_init_guides_slider_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/init-guides-slider.js */ "./js/modules/init-guides-slider.js");
/* harmony import */ var _modules_init_popular_tours_slider_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/init-popular-tours-slider.js */ "./js/modules/init-popular-tours-slider.js");
/* harmony import */ var _modules_init_tour_reviews_slider_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-tour-reviews-slider.js */ "./js/modules/init-tour-reviews-slider.js");
/* harmony import */ var _modules_init_custom_select_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-custom-select.js */ "./js/modules/init-custom-select.js");
...
window.addEventListener('DOMContentLoaded', function () {
  window.addEventListener('load', function () {
    ...
    (0,_modules_init_guides_slider_js__WEBPACK_IMPORTED_MODULE_1__.initGuidesSlider)();
    (0,_modules_init_popular_tours_slider_js__WEBPACK_IMPORTED_MODULE_2__.initPopularToursSlider)();
    (0,_modules_init_tour_reviews_slider_js__WEBPACK_IMPORTED_MODULE_3__.initTourReviewsSlider)();
    (0,_modules_init_custom_select_js__WEBPACK_IMPORTED_MODULE_4__.initCustomSelect)();
  });
});
}();
/******/ })()
